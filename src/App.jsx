    ...
    <nav className="bg-white/95 backdrop-blur-sm border-b border-sky-100 text-slate-800 sticky top-0 z-50 transition-all duration-300">
      <div className="max-w-6xl mx-auto px-6 h-20 flex justify-between items-center">
        ...
        <Link 
          ...
          className="text-2xl md:text-3xl font-extrabold tracking-tighter text-sky-400 group flex items-center gap-1"
        >
          Nate & <span className="text-pink-400 group-hover:scale-110 transition-transform duration-300">Kisses</span> 
          <span className="text-xl md:text-2xl">🍬</span>
        </Link>

        {/* Desktop Navigation Link Menu (Hidden on mobile screen sizes) */}
        <div className="hidden md:flex gap-8 text-sm font-bold tracking-wide uppercase text-slate-600">
        ...
        <button 
          ...
          className="md:hidden p-2 text-slate-600 hover:text-pink-400 transition-colors focus:outline-none"
      ...
      <div 
        className={`md:hidden absolute top-20 left-0 w-full bg-white border-b border-sky-50 shadow-lg shadow-pink-500/5 transition-all duration-300 ease-in-out origin-top ${
          isOpen ? 'opacity-100 scale-y-100 visible' : 'opacity-0 scale-y-95 invisible h-0 overflow-hidden'
        }`}
      >
        <div className="flex flex-col px-6 py-6 gap-4 text-sm font-bold tracking-wide uppercase text-slate-600">
          <Link 
            to="/" 
            onClick={() => setIsOpen(false)} 
            className="hover:text-pink-400 py-2 border-b border-slate-50 transition-colors duration-200"
          >
            Home
          </Link>
          <Link 
          ...
          <Link 
            to="/about" 
            onClick={() => setIsOpen(false)} 
            className="hover:text-pink-400 py-2 transition-colors duration-200"
          >
            About Us
          </Link>
        </div>
